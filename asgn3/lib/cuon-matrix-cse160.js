...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var one = other1.elements;
        var two = other2.elements;

        v3.elements[0] = one[1] * two[2] - one[2] * two[1];
        v3.elements[1] = one[2] * two[0] - one[0] * two[2];
        v3.elements[2] = one[0] * two[1] - one[1] * two[0];
    ...
    magnitude() {
        ...
        m += Math.pow(this.elements[0], 2);
        m += Math.pow(this.elements[1], 2);
